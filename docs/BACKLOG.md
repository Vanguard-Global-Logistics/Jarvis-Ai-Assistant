...
| **Job Site Progress**                                                                   | Technician progress, punch lists, product ETA alerts, nightly job briefs and cost-center labor forecasts so William can manage by exception and visit sites | Automation Control accepted; BCI Agent accepted; employer and Simpro authorization; multi-user identity; AEGIS | very high              | unknown               | Read-only OAuth pilot first; midnight reconciliation plus stale-data alarm; source-linked ETA; transparent labor; no covert surveillance, payroll write or automatic discipline |
