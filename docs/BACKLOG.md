...
| **Job Site Progress** | Technician progress, daily punch lists, blockers, evidence and future labor forecasting so William can manage by exception and visit sites | Automation Control accepted; BCI Agent accepted; employer authorization; multi-user identity; AEGIS | very high | unknown | Field pilot first; transparent self-reporting; no covert surveillance, payroll write or automatic discipline |
