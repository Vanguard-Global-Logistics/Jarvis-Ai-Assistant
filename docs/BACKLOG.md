...
| **Jarvis Professional Mode**                                                            | Help William master his job and buy back time without becoming an employer program                                                                                   | AEGIS; isolated professional vault; approved-source adapters                                                                        | high                   | $0 local target       | Personal, supervised, source-cited, draft-first; employer deployment is separate and not implied                                                                      |
| **BCI Agent**                                                                           | Cover recurring project-management problems and administrative load so William can recover time and improve at his job                                               | Jarvis supervision contract; AEGIS; isolated professional vault; approved work sources                                              | high                   | $0 local target       | Separate William-owned program; reconcile existing code and evidence before adding features; no employer ownership implied                                            |
| **Automation Control Layer**                                                            | Let Jarvis safely operate William's certified existing programs                                                                                                      | Daily-use Jarvis accepted; automation inventory; AEGIS/Hermes adapters; approvals                                                   | high                   | $0 local target       | Inventory and test every program before control; no unrestricted shell or shared credentials                                                                          |
| **Coolify Deployment Plane**                                                            | Self-host approved Octagon, Job Site Progress, BCI/Simpro gateways and remote APIs without making the Mac a server                                                   | Stage 1B accepted; hosting ADR; separate Linux VPS; AEGIS deployment adapter                                                        | high                   | VPS + backup costs    | Never install on the 8 GB Mac; no Jarvis root/terminal access; promote only after restore, rollback and isolation evidence                                            |
| **Job Site Progress**                                                                   | Daily technician report loop, punch lists, product ETA alerts, nightly job briefs and cost-center labor forecasts so William can manage by exception and visit sites | Automation Control accepted; BCI Agent accepted; employer and Simpro authorization; enrolled recipients; multi-user identity; AEGIS | very high              | unknown               | 7:00 request and bounded hourly reminders stop on valid reply; read-only OAuth reconciliation; no covert location/surveillance, payroll write or automatic discipline |
| Business platforms (Sophisticated Sips, Vanguard Performance Labs, Peptastic, Saltline) | Chartered in `CLAUDE.md` §7                                                                                                                                          | Scope definition by William; multi-user + regulated-domain rules undefined                                                          | very high              | unknown               | Explicitly blocked on William defining scope — do not infer                                                                                                           |
